package feathers.controls
{
   ...
   public class Callout extends FeathersControl
   {
      ...
      protected function layoutChildren() : void
      {
         ...
         var _loc6_:Number = this._leftArrowSkin && this._arrowPosition == "left" ? this._leftArrowSkin.width + this._leftArrowGap : 0;
         var _loc9_:Number = this._topArrowSkin && this._arrowPosition == "top" ? this._topArrowSkin.height + this._topArrowGap : 0;
         var _loc5_:Number = this._rightArrowSkin && this._arrowPosition == "right" ? this._rightArrowSkin.width + this._rightArrowGap : 0;
         var _loc1_:Number = this._bottomArrowSkin && this._arrowPosition == "bottom" ? this._bottomArrowSkin.height + this._bottomArrowGap : 0;
      ...
      protected function positionToOrigin() : void
      {
         ...
         var _loc1_:Boolean = this._lastGlobalBoundsOfOrigin != null;
