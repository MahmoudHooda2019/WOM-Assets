   ...
   public class StageTextTextEditor extends FeathersControl implements ITextEditor
   {
      ...
      override public function render(param1:RenderSupport, param2:Number) : void
      {
         ...
         if(HELPER_POINT.x != this._oldGlobalX || HELPER_POINT.y != this._oldGlobalY)
         {
            ...
            _loc3_ = Starling.current.viewPort;
            _loc4_ = this.stageText.viewPort;
            if(!_loc4_)
            {
               _loc4_ = new Rectangle();
            }
            _loc4_.x = Math.round(_loc3_.x + HELPER_POINT.x * Starling.contentScaleFactor);
            _loc4_.y = Math.round(_loc3_.y + HELPER_POINT.y * Starling.contentScaleFactor);
            this.stageText.viewPort = _loc4_;
         }
      ...
      protected function layout(param1:Boolean) : void
      {
         ...
         if(!this._stageTextHasFocus && (_loc8_ || _loc5_ || param1 || this._needsNewTexture))
         {
            ...
            if(this.textSnapshot)
            {
               this.textSnapshot.visible = _loc9_;
            }
         }
      ...
      protected function refreshStageTextProperties() : void
      {
         ...
         this.stageText.fontSize = this._fontSize * Starling.contentScaleFactor * _loc4_;
         ...
         var _loc5_:TextFormat = this._measureTextField.defaultTextFormat;
         _loc5_.color = this._color;
         _loc5_.font = this._fontFamily;
         _loc5_.italic = this._fontPosture == "italic";
         _loc5_.size = this._fontSize;
         _loc5_.bold = this._fontWeight == "bold";
         ...
         _loc5_.align = _loc1_;
         this._measureTextField.defaultTextFormat = _loc5_;
         this._measureTextField.setTextFormat(_loc5_);
      }
      ...
      protected function refreshViewPort() : void
      {
         ...
         var _loc6_:Rectangle = this.stageText.viewPort;
         if(!_loc6_)
         {
         ...
         this._oldGlobalX = HELPER_POINT.x;
         this._oldGlobalY = HELPER_POINT.y;
         _loc6_.x = Math.round(_loc3_.x + HELPER_POINT.x * Starling.contentScaleFactor);
         _loc6_.y = Math.round(_loc3_.y + HELPER_POINT.y * Starling.contentScaleFactor);
         var _loc5_:Number = Math.round(this.actualWidth * Starling.contentScaleFactor * _loc2_);
         if(_loc5_ < 1 || isNaN(_loc5_))
         {
            _loc5_ = 1;
         }
         var _loc4_:Number = Math.round(this.actualHeight * Starling.contentScaleFactor * _loc1_);
         if(_loc4_ < 1 || isNaN(_loc4_))
         {
            _loc4_ = 1;
         }
         _loc6_.width = _loc5_;
         _loc6_.height = _loc4_;
         this.stageText.viewPort = _loc6_;
         this._measureTextField.width = this.actualWidth;
         this._measureTextField.height = this.actualHeight;
      }
