   ...
   public class SimpleScrollBar extends FeathersControl implements IScrollBar
   {
      ...
      protected function layout() : void
      {
         ...
         if(this._direction == "vertical")
         {
            ...
            _loc5_ = this.thumb.minHeight > 0 ? this.thumb.minHeight : this.thumbOriginalHeight;
            ...
            _loc9_ *= _loc11_ / (_loc1_ * _loc7_ / _loc10_);
            _loc7_ -= _loc9_;
            if(_loc7_ < _loc5_)
            {
               _loc7_ = _loc5_;
         ...
         else
         {
            ...
            _loc4_ = _loc6_ - _loc13_;
            if(_loc4_ > _loc13_)
            {
               _loc4_ = _loc13_;
            }
            _loc4_ *= _loc11_ / (_loc1_ * _loc13_ / _loc6_);
            _loc13_ -= _loc4_;
            if(_loc13_ < _loc3_)
            {
               _loc13_ = _loc3_;
