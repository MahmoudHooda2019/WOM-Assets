package feathers.controls
{
   ...
   public class List extends Scroller implements IFocusDisplayObject
   {
      ...
      public function get selectedItems() : Vector.<Object>
      {
         ...
         var _loc3_:Vector.<Object> = new Vector.<Object>(0);
         var _loc2_:int = this._selectedIndices.length;
         _loc5_ = 0;
         while(_loc5_ < _loc2_)
         {
            _loc1_ = this._selectedIndices.getItemAt(_loc5_) as int;
            _loc4_ = this._dataProvider.getItemAt(_loc1_);
            _loc3_.push(_loc4_);
            _loc5_++;
         }
         return _loc3_;
      ...
      override protected function initialize() : void
      {
         ...
         var _loc2_:Boolean = this._layout != null;
         super.initialize();
         ...
         if(!_loc2_)
         {
            ...
            _loc1_.paddingTop = _loc1_.paddingRight = _loc1_.paddingBottom = _loc1_.paddingLeft = 0;
            _loc1_.gap = 0;
