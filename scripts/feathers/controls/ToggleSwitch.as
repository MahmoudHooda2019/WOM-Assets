package feathers.controls
{
   ...
   public class ToggleSwitch extends FeathersControl implements IToggle, IFocusDisplayObject
   {
      ...
      protected function layoutChildren() : void
      {
         ...
         if(this.onTextRenderer is FeathersControl)
         {
            _loc3_ = FeathersControl(this.onTextRenderer).clipRect;
            _loc3_.width = _loc1_;
            _loc3_.height = _loc4_;
            FeathersControl(this.onTextRenderer).clipRect = _loc3_;
         }
         this.onTextRenderer.y = (this.actualHeight - _loc2_) / 2;
         if(this.offTextRenderer is FeathersControl)
         {
            _loc3_ = FeathersControl(this.offTextRenderer).clipRect;
            _loc3_.width = _loc1_;
            _loc3_.height = _loc4_;
            FeathersControl(this.offTextRenderer).clipRect = _loc3_;
         }
      ...
      {
         var _loc6_:FeathersControl = null;
         var _loc1_:Rectangle = null;
         var _loc3_:FeathersControl = null;
         var _loc2_:Number = Math.max(0,this.actualWidth - this.thumb.width - this._paddingLeft - this._paddingRight);
         var _loc5_:Number = this.thumb.x - this._paddingLeft;
         var _loc4_:Number = _loc2_ - _loc5_ - (_loc2_ - this.onTextRenderer.width) / 2;
         if(this.onTextRenderer is FeathersControl)
         {
            _loc6_ = FeathersControl(this.onTextRenderer);
            _loc1_ = _loc6_.clipRect;
            _loc1_.x = _loc4_;
            _loc6_.clipRect = _loc1_;
         }
         this.onTextRenderer.x = this._paddingLeft - _loc4_;
         var _loc7_:Number = -_loc5_ - (_loc2_ - this.offTextRenderer.width) / 2;
         if(this.offTextRenderer is FeathersControl)
         {
            _loc3_ = FeathersControl(this.offTextRenderer);
            _loc1_ = _loc3_.clipRect;
            _loc1_.x = _loc7_;
            _loc3_.clipRect = _loc1_;
         }
         this.offTextRenderer.x = this.actualWidth - this._paddingRight - _loc2_ - _loc7_;
         if(this._trackLayoutMode == "onOff")
         {
