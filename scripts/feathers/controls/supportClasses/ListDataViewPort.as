package feathers.controls.supportClasses
{
   ...
   public final class ListDataViewPort extends FeathersControl implements IViewPort
   {
      ...
      private var _inactiveRenderers:Vector.<IListItemRenderer> = new Vector.<IListItemRenderer>(0);
      
      private var _activeRenderers:Vector.<IListItemRenderer> = new Vector.<IListItemRenderer>(0);
      ...
      override protected function draw() : void
      {
         ...
         if(_loc3_ || _loc4_ || _loc6_ || _loc11_ || _loc5_)
         {
            this.refreshInactiveRenderers(_loc5_);
         }
         if(_loc9_ || _loc6_ || _loc11_ || _loc5_)
         {
         ...
         if(_loc3_ || _loc9_ || _loc4_ || _loc6_ || _loc11_ || _loc5_)
         {
            this.refreshItemRendererStyles();
         }
         if(_loc3_ || _loc2_ || _loc4_ || _loc6_ || _loc11_ || _loc5_)
         {
            this.refreshSelection();
         }
         if(_loc3_ || _loc8_ || _loc4_ || _loc6_ || _loc11_ || _loc5_)
         {
            this.refreshEnabled();
         }
      ...
      private function validateItemRenderers() : void
      {
         ...
         var _loc1_:int = int(this._activeRenderers.length);
         _loc3_ = 0;
         while(_loc3_ < _loc1_)
         {
      ...
      {
         var _loc5_:IVirtualLayout = this._layout as IVirtualLayout;
         if(!_loc5_ || !_loc5_.useVirtualLayout)
         {
         ...
         if(_loc2_)
         {
            if(this._dataProvider)
            {
               _loc3_ = this._dataProvider.getItemIndex(_loc2_);
               _loc4_ = _loc3_ >= 0;
            }
            if(_loc3_ < 0)
            {
         ...
         else
         {
            ...
            {
               _loc5_.typicalItem = null;
               return;
            }
            _loc2_ = this._dataProvider.getItemAt(0);
         }
         var _loc1_:IListItemRenderer = IListItemRenderer(this._rendererMap[_loc2_]);
         if(!_loc1_ && !_loc4_ && !this._typicalItemIsInDataProvider && this._typicalItemRenderer)
         {
            _loc1_ = this._typicalItemRenderer;
            _loc1_.data = _loc2_;
            _loc1_.index = _loc3_;
         }
         if(!_loc1_)
         {
            _loc1_ = this.createRenderer(_loc2_,_loc3_,false,!_loc4_);
            if(!this._typicalItemIsInDataProvider && this._typicalItemRenderer)
            {
               this.destroyRenderer(this._typicalItemRenderer);
               this._typicalItemRenderer = null;
         ...
         _loc5_.typicalItem = DisplayObject(_loc1_);
         this._typicalItemRenderer = _loc1_;
      ...
      {
         var _loc3_:int = 0;
         var _loc1_:IFeathersControl = null;
         var _loc2_:int = int(this._activeRenderers.length);
         _loc3_ = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      private function refreshRenderers() : void
      {
         ...
         if(this._typicalItemRenderer && this._typicalItemIsInDataProvider)
         {
            ...
            _loc1_ = int(this._activeRenderers.length);
            if(_loc1_ == 0)
            {
      ...
      private function findUnrenderedData() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc11_:int = 0;
         var _loc8_:ITrimmedVirtualLayout = null;
         var _loc10_:Object = null;
         var _loc14_:IListItemRenderer = null;
         var _loc9_:int = 0;
         var _loc13_:int = int(this._dataProvider ? this._dataProvider.length : 0);
         ...
         var _loc4_:int = int(_loc15_ ? HELPER_VECTOR.length : _loc13_);
         ...
         if(_loc7_)
         {
            _loc3_ = _loc16_ = HELPER_VECTOR[0];
            _loc5_ = 1;
            while(_loc5_ < _loc4_)
            {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc1_ = _loc15_ ? HELPER_VECTOR[_loc5_] : int(_loc5_);
      ...
      private function recoverInactiveRenderers() : void
      {
         var _loc3_:int = 0;
         var _loc2_:IListItemRenderer = null;
         var _loc1_:int = int(this._inactiveRenderers.length);
         _loc3_ = 0;
         while(_loc3_ < _loc1_)
         {
      ...
      private function renderer_changeHandler(param1:Event) : void
      {
         ...
         var _loc3_:Boolean = Boolean(_loc4_.isSelected);
