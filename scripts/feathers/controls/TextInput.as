package feathers.controls
{
   ...
   public class TextInput extends FeathersControl implements IFocusDisplayObject
   {
      ...
      protected var _stateNames:Vector.<String> = new <String>["enabled","disabled","focused"];
      ...
      public function selectRange(param1:int, param2:int = -1) : void
      {
         ...
         {
            throw new RangeError("Expected start index > " + this._text.length + ". Received " + param2 + ".");
         }
         if(this.textEditor)
         {
