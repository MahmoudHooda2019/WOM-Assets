package feathers.system
{
   ...
   public class DeviceCapabilities
   {
      ...
      {
         var _loc3_:Number = Number(isNaN(screenPixelWidth) ? param1.fullScreenWidth : screenPixelWidth);
         var _loc2_:Number = Number(isNaN(screenPixelHeight) ? param1.fullScreenHeight : screenPixelHeight);
      ...
      {
         var _loc2_:Number = Number(isNaN(screenPixelWidth) ? param1.fullScreenWidth : screenPixelWidth);
         return _loc2_ / dpi;
      }
