package feathers.core
{
   ...
   public class FocusManager implements IFocusManager
   {
      ...
      protected static const stack:Vector.<IFocusManager> = new Vector.<IFocusManager>(0);
      ...
      public static function pushFocusManager(param1:IFocusManager = null) : IFocusManager
      {
         var _loc2_:IFocusManager = null;
         if(!param1)
         {
            param1 = new FocusManager(null,false);
         }
         if(stack.length > 0)
         {
      ...
      public static function popFocusManager() : void
      {
         ...
         var _loc1_:IFocusManager = stack[stack.length - 1];
      ...
      protected function setFocusManager(param1:DisplayObject) : void
      {
         ...
         {
            _loc5_ = IFocusDisplayObject(param1);
      ...
      protected function findPreviousFocus(param1:DisplayObjectContainer, param2:DisplayObject = null) : IFocusDisplayObject
      {
         ...
         var _loc8_:Boolean = param2 == null;
      ...
      protected function findNextFocus(param1:DisplayObjectContainer, param2:DisplayObject = null) : IFocusDisplayObject
      {
         ...
         var _loc11_:Boolean = param2 == null;
         if(param1 is IFocusExtras)
         {
      ...
      protected function topLevelContainer_touchHandler(param1:TouchEvent) : void
      {
         ...
         do
         {
            ...
            {
               _loc4_ = IFocusDisplayObject(_loc3_);
            }
