package starling.text
{
   ...
   public class TextField extends DisplayObjectContainer
   {
      ...
      private function renderText(param1:Number, param2:Rectangle) : BitmapData
      {
         ...
         var _loc12_:BitmapData = new BitmapData(_loc3_,_loc4_,true,0);
         var _loc13_:Matrix = new Matrix(1,0,0,1,0,int(_loc11_) - 2);
         var _loc14_:Function = "drawWithQuality" in _loc12_ ? _loc12_["drawWithQuality"] : null;
         if(_loc14_ is Function)
         {
            _loc14_.call(_loc12_,sNativeTextField,_loc13_,null,null,null,false,StageQuality.MEDIUM);
         }
         else
         {
            _loc12_.draw(sNativeTextField,_loc13_);
         }
         sNativeTextField.text = "";
         param2.setTo(_loc10_ / param1,_loc11_ / param1,_loc8_ / param1,_loc9_ / param1);
         return _loc12_;
      }
