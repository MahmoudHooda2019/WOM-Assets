   ...
   public class RenderSupport
   {
      ...
      public function applyClipRect() : void
      {
         ...
         if(this.mClipRectStackSize > 0)
         {
            ...
            sRectangle.setTo(_loc4_.x,_loc4_.y,_loc4_.width,_loc4_.height);
            ...
            sRectangle.x = sPoint.x > -1 ? (sPoint.x + 1) / 2 * _loc2_ : 0;
            sRectangle.y = sPoint.y > -1 ? (-sPoint.y + 1) / 2 * _loc3_ : 0;
            MatrixUtil.transformCoords(this.mProjectionMatrix,_loc4_.right,_loc4_.bottom,sPoint);
            sRectangle.right = sPoint.x < 1 ? (sPoint.x + 1) / 2 * _loc2_ : _loc2_;
            sRectangle.bottom = sPoint.y < 1 ? (-sPoint.y + 1) / 2 * _loc3_ : _loc3_;
