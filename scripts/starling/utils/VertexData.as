package starling.utils
{
   ...
   public class VertexData
   {
      ...
      public function setColorAndAlpha(param1:int, param2:uint, param3:Number) : void
      {
         ...
         this.mRawData[_loc4_] = (param2 >> 16 & 0xFF) / 255 * _loc5_;
         this.mRawData[int(_loc4_ + 1)] = (param2 >> 8 & 0xFF) / 255 * _loc5_;
         this.mRawData[int(_loc4_ + 2)] = (param2 & 0xFF) / 255 * _loc5_;
      ...
      public function set numVertices(param1:int) : void
      {
         ...
         var _loc2_:* = this.mNumVertices;
         while(_loc2_ < param1)
         {
            this.mRawData[int(_loc2_ * ELEMENTS_PER_VERTEX + COLOR_OFFSET + 3)] = 1;
            _loc2_++;
         }
