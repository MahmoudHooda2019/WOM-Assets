package starling.display.materials
{
   ...
   public interface IMaterial
   {
      ...
      function dispose(param1:Boolean = false) : void;
      ...
      function drawTriangles(param1:Context3D, param2:Matrix3D, param3:VertexBuffer3D, param4:IndexBuffer3D, param5:Number = 1) : void;
