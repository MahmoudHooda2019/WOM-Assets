package starling.display.graphics
{
   public class RoundedRectangle extends Graphic
   {
      ...
      {
         param1 = param1 < 0 ? 0 : param1;
         _topLeftRadius = _topRightRadius = _bottomLeftRadius = _bottomRightRadius = param1;
         isInvalid = true;
      }
      ...
      override protected function buildGeometry() : void
      {
         ...
         {
            _loc9_ = _loc3_ * 0.25;
            _loc9_ = int(_loc9_ < 1 ? 1 : _loc9_);
            _loc6_ = 0;
            while(_loc6_ < _loc9_)
            {
               _loc1_ = (_loc6_ + 1) / (_loc9_ + 1) * 3.141592653589793 * 0.5;
               _loc1_ += 3.141592653589793 * 1.5;
