package org.swiftsuspenders
{
   ...
   public class Injector
   {
      ...
      {
         var _loc7_:InjectionPoint = null;
         ...
         var _loc3_:InjecteeDescription = this.m_injecteeDescriptions[_loc2_] || this.getInjectionPoints(_loc2_);
      ...
      internal function getAncestorMapping(param1:Class, param2:String = null) : InjectionConfig
      {
         ...
         while(_loc3_)
         {
            _loc4_ = _loc3_.getConfigurationForRequest(param1,param2,false);
            if((Boolean(_loc4_)) && _loc4_.hasOwnResponse())
            {
               return _loc4_;
            }
      ...
      private function getConfigurationForRequest(param1:Class, param2:String, param3:Boolean = true) : InjectionConfig
      {
         ...
         if(Boolean(!_loc5_ && param3) && Boolean(this.m_parentInjector) && this.m_parentInjector.hasMapping(param1,param2))
         {
