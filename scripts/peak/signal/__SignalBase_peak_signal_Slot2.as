package peak.signal
{
   public class __SignalBase_peak_signal_Slot2
   {
      
      public var readLock:Boolean = false;
      
      public var handlersOnce:__SlotList_peak_signal_Slot2 = new __SlotList_peak_signal_Slot2();
      
      public var handlers:__SlotList_peak_signal_Slot2 = new __SlotList_peak_signal_Slot2();
      
      public var dispatchesInProgress:int = 0;
      
      public function __SignalBase_peak_signal_Slot2()
      {
      }
      
      public function removeFunction(param1:Function) : Boolean
      {
         var _loc2_:* = null as __SlotList_peak_signal_Slot2;
         ...
         var _loc6_:* = null as __SlotNode_peak_signal_Slot2;
         if(readLock)
         {
            §§push(§§findproperty(handlers));
            _loc2_ = handlers;
            _loc3_ = new __SlotList_peak_signal_Slot2();
            _loc4_ = _loc2_.head;
            _loc5_ = _loc2_.tail;
            _loc6_ = _loc3_.head;
            while(_loc4_ != _loc5_)
            {
               _loc4_ = _loc4_.next;
               _loc6_.next = new __SlotNode_peak_signal_Slot2(_loc4_.handler,_loc4_.next);
               _loc6_ = _loc6_.next;
            }
            _loc3_.tail = _loc6_;
            §§pop().handlers = _loc3_;
      ...
      {
         handlers = new __SlotList_peak_signal_Slot2();
         handlersOnce = new __SlotList_peak_signal_Slot2();
         readLock = false;
      }
      
      public function remove(param1:Slot2) : Boolean
      {
         var _loc2_:* = null as __SlotList_peak_signal_Slot2;
         var _loc3_:* = null as __SlotList_peak_signal_Slot2;
         var _loc4_:* = null as __SlotNode_peak_signal_Slot2;
      ...
      public function hasHandler(param1:Slot2) : Boolean
      {
         var _loc2_:* = null as __SlotNode_peak_signal_Slot2;
      ...
      public function hasFunctionHandler(param1:Function) : Boolean
      {
         ...
         var _loc3_:* = null as __SlotNode_peak_signal_Slot2;
      ...
      {
         var _loc1_:* = null as __SlotList_peak_signal_Slot2;
         §§push(false);
         _loc1_ = handlers;
      ...
      public function addOnce(param1:Slot2) : void
      {
         var _loc2_:__SlotList_peak_signal_Slot2 = handlersOnce;
         var _loc3_:__SlotNode_peak_signal_Slot2 = new __SlotNode_peak_signal_Slot2(param1,null);
         _loc2_.tail.next = _loc3_;
         _loc2_.tail = _loc3_;
      }
      
      public function add(param1:Slot2) : void
      {
