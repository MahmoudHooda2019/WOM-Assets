package peak.resource.asset.extended
{
   ...
   public class FlippedBitmapAsset extends SingleSourceBitmapAsset
   {
      
      protected var _axis:String;
      
      public function FlippedBitmapAsset(param1:String, param2:String = "Y", param3:Scale9AssetPainter = null, param4:Vector.<Point> = null)
      {
      ...
      override protected function draw() : void
      {
         ...
         this._bitmapData = BitmapUtil.flipBitmapData(_loc1_.bitmapData,_axis);
      }
   }
}
