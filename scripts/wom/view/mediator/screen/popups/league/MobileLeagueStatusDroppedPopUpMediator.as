package wom.view.mediator.screen.popups.league
{
   ...
   public class MobileLeagueStatusDroppedPopUpMediator extends MobileGenericWindowMediator
   {
      
      [Inject]
      public var view:MobileLeagueStatusDroppedPopUp;
      
      public function MobileLeagueStatusDroppedPopUpMediator()
      {
         super();
      }
