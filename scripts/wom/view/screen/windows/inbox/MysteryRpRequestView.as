package wom.view.screen.windows.inbox
{
   ...
   public class MysteryRpRequestView extends BaseRequestView
   {
      ...
      public function MysteryRpRequestView(param1:RequestInfo)
      {
      ...
      override public function drawLayout() : void
      {
         ...
         AlignmentUtil.alignAccordingToPositionOf(_rpAsset,background,6,6);
