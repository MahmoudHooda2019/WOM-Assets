package wom.view.screen.windows.hiringquarters
{
   ...
   public class HiringQuartersInProgressView extends CustomCursorAwareSprite implements View
   {
      ...
      public function HiringQuartersInProgressView(param1:String, param2:int, param3:Boolean = false)
      {
         super();
      ...
      {
         mercenaryPicture = assetRepository.getDisplayObject(mercenaryAsset);
         addChild(mercenaryPicture);
         _closeIcon = assetRepository.getDisplayObject("HiringQuartersCancel");
