package wom.view.screen.windows.watchpost
{
   ...
   import wom.view.screen.windows.transfer.MercenaryTransferWindow;
   
   public class WatchPostWindow extends MercenaryTransferWindow
   {
      ...
      public function WatchPostWindow(param1:int, param2:int)
      {
         super(1);
         _instanceId = param1;
