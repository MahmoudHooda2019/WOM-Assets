package wom.view.screen.windows.battlepoints
{
   ...
   public class MobileBattlePointsInfoWindow extends MobileGenericWindow
   {
      ...
      public function MobileBattlePointsInfoWindow()
      {
         super(830,661);
      }
      ...
      override protected function initLayout() : void
      {
         ...
         var _loc3_:int = 0;
         super.initLayout();
         var _loc4_:String = "ui.windows.battlepoints.header";
         ...
         var _loc5_:String = "ui.windows.battlepoints.tips.title";
         ...
         while(_loc3_ < 6)
         {
            ...
            addChild(_loc2_);
            var _temp_8:* = _loc2_;
            var _loc6_:String = "ui.windows.battlepoints.tips." + _loc3_;
