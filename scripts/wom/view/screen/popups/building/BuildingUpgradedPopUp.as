package wom.view.screen.popups.building
{
   ...
   public class BuildingUpgradedPopUp extends GenericBuildingPopUp
   {
      
      public function BuildingUpgradedPopUp(param1:BuildingTypeDIO, param2:int)
      {
         super(param1,param2);
      }
      ...
      {
         super.initLayout();
         var _temp_1:* = "ui.popups.building.upgraded.header";
         ...
         var _temp_3:* = "domain.buildingkinds." + buildingTypeDIO.kind.id + ".buildingupgraded";
