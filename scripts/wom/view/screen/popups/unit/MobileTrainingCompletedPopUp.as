package wom.view.screen.popups.unit
{
   ...
   public class MobileTrainingCompletedPopUp extends MobileGenericUnitCompletionPopUp
   {
      
      private var _level:int;
      
      public function MobileTrainingCompletedPopUp(param1:GenericUnitTypeDIO, param2:int)
      {
         super(param1);
         _level = param2;
      }
