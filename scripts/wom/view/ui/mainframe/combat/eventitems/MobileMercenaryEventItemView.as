package wom.view.ui.mainframe.combat.eventitems
{
   ...
   public class MobileMercenaryEventItemView extends MobileCombatEventItemView
   {
      
      private var _relatedId:int;
      
      public function MobileMercenaryEventItemView(param1:EventItemDIO, param2:int, param3:int = -1)
      {
         super(param1,param2);
         _relatedId = param3;
      }
