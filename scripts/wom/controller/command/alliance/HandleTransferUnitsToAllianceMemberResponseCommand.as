package wom.controller.command.alliance
{
   ...
   public class HandleTransferUnitsToAllianceMemberResponseCommand extends PCommand
   {
      ...
      public function HandleTransferUnitsToAllianceMemberResponseCommand()
      {
         super();
      }
      ...
      override public function execute() : void
      {
         ...
         var _loc1_:TransferUnitsToAllianceMemberResponse = messageReceivedEvent.message as TransferUnitsToAllianceMemberResponse;
         if(_loc1_.resultCode != 0)
         {
            return;
         }
         dispatch(new UnitsOfMemberOrFriendReceivedEvent("unitsOfAllianceMemberReceived",_loc1_.allianceBarracksLevel,_loc1_.availableBarracksCapacity,_loc1_.memberUnits,_loc1_.unitLevels));
         if(_loc1_.source == 1)
         {
            _loc6_ = 0;
