package wom.model.message.response.alliance
{
   ...
   public class GetAllianceMemberContributionsResponse extends AbstractIncomingMessage
   {
      ...
      public function GetAllianceMemberContributionsResponse()
      {
         super();
      }
      ...
      override public function deserialize(param1:Object) : void
      {
         ...
         if(_resultCode == 0)
         {
            ...
            for each(var _loc3_ in param1.contributions)
            {
               _loc2_ = new AllianceMemberInfo(new Profile(_loc3_.memberGuid,_loc3_.memberPid,_loc3_.avatar),_loc3_.level,_loc3_.battlePoints,_loc3_.leader,1,_loc3_.score,_loc3_.availableAllianceBarracksCapacity,_loc3_.allianceBarracksLevel,_loc3_.tournamentCP);
               _loc4_.push(_loc2_);
            }
