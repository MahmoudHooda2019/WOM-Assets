package wom.model.message.response
{
   ...
   public class ExtendBattleDurationResponse extends AbstractIncomingMessage
   {
      ...
      public function ExtendBattleDurationResponse()
      {
         super();
      }
      ...
      override public function deserialize(param1:Object) : void
      {
         ...
         _remainingTime = param1.remainingDuration;
      }
