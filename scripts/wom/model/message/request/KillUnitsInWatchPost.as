package wom.model.message.request
{
   ...
   public class KillUnitsInWatchPost extends AbstractOutgoingMessage implements OutgoingMessage
   {
      ...
      public function KillUnitsInWatchPost(param1:int, param2:Vector.<UnitTypeAmountDTO>)
      {
         super();
