package wom.model.message.notification
{
   ...
   public class BuildingLevelUpgradeJobScheduledEventNotification extends AbstractIncomingMessage
   {
      ...
      public function BuildingLevelUpgradeJobScheduledEventNotification()
      {
         super();
      }
