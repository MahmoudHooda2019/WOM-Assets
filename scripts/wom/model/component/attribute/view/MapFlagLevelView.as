package wom.model.component.attribute.view
{
   ...
   public class MapFlagLevelView extends BaseView
   {
      ...
      public function MapFlagLevelView(param1:MapTileData, param2:WomAssetRepository)
      {
         super(3);
         this.data = param1;
      ...
      {
         super.init();
         bitmapData = MapAssetOpearator.getMapLevel(data,assetRepository);
      }
   }
}
