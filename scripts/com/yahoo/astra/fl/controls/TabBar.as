package com.yahoo.astra.fl.controls
{
   ...
   public class TabBar extends UIComponent implements IFocusManagerComponent
   {
      ...
      protected function buttonRollOutHandler(param1:MouseEvent) : void
      {
         ...
         _loc3_ = this.buttons.indexOf(_loc2_);
      ...
      public function itemToLabel(param1:Object) : String
      {
         ...
         else if(Boolean(this.labelField) && param1.hasOwnProperty(this.labelField))
         {
      ...
      override protected function draw() : void
      {
         ...
         _loc1_ = this.isInvalid(InvalidationType.DATA);
         if(_loc1_)
         {
            this.createCache();
      ...
      protected function drawButtons() : void
      {
         ...
         _loc1_ = this.isInvalid(InvalidationType.STYLES);
         _loc2_ = this.isInvalid(InvalidationType.RENDERER_STYLES);
         _loc3_ = 0;
      ...
      protected function navigationKeyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         switch(param1.keyCode)
         {
            ...
            case Keyboard.DOWN:
            case Keyboard.RIGHT:
               _loc2_ = this.focusIndex == this.numChildren - 1 ? 0 : int(this.focusIndex + 1);
            ...
            case Keyboard.UP:
            case Keyboard.LEFT:
               _loc2_ = this.focusIndex == 0 ? int(this.numChildren - 1) : int(this.focusIndex - 1);
               if(this.selectionFollowsKeyboardFocus)
               {
                  this.selectedIndex = _loc2_;
               }
