   ...
   public class TweenMax extends TweenLite implements IEventDispatcher
   {
      ...
      override public function renderTime(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         if(_repeat != 0)
         {
            ...
            if((_cyclesComplete = this.cachedTotalTime / _loc10_ >> 0) == this.cachedTotalTime / _loc10_ && _cyclesComplete != 0)
            {
               --_cyclesComplete;
            }
            _loc7_ = Boolean(_loc11_ != _cyclesComplete);
            if(_loc6_)
            {
            ...
            {
               this.cachedTime = this.cachedTotalTime - _cyclesComplete * _loc10_;
